...
ActiveRecord::Schema.define(version: 20170528105033) do
  ...
  create_table "call_for_participations", id: :serial, force: :cascade do |t|
  ...
  create_table "conference_exports", id: :serial, force: :cascade do |t|
    t.string "locale"
    t.integer "conference_id"
  ...
  create_table "conference_users", id: :serial, force: :cascade do |t|
    t.string "role"
    t.integer "user_id"
    t.integer "conference_id"
    t.datetime "created_at"
  ...
  create_table "event_feedbacks", id: :serial, force: :cascade do |t|
    t.integer "event_id"
    t.float "rating"
    t.text "comment"
    t.datetime "created_at"
  ...
  create_table "event_people", id: :serial, force: :cascade do |t|
    t.integer "event_id", null: false
  ...
  create_table "event_ratings", id: :serial, force: :cascade do |t|
    t.integer "event_id"
    t.integer "person_id"
    t.float "rating"
    t.text "comment"
  ...
  create_table "im_accounts", id: :serial, force: :cascade do |t|
    t.integer "person_id"
    t.string "im_type"
    t.string "im_address"
    t.datetime "created_at"
  ...
  create_table "ticket_servers", id: :serial, force: :cascade do |t|
    t.integer "conference_id", null: false
    t.string "url"
    t.string "user"
    t.string "password"
  ...
  create_table "transport_needs", id: :serial, force: :cascade do |t|
    t.integer "person_id"
    t.integer "conference_id"
    t.datetime "at"
